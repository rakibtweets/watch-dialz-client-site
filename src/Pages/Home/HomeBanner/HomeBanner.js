        ...
        <Carousel.Item>
          <div className="slide-1 japan-tokyo  text-white d-flex justify-content-start align-items-center">
            <div className=" container ps-5">
              ...
              <Link to="watches">
                <button className="btn btn-secondary px-4 py-2 mt-3">
        ...
        <Carousel.Item>
          <div className="slide-2  text-dark d-flex justify-content-start justify-content-lg-center align-items-center">
            <div className="slide_contenter  w-75 mx-auto text-start">
              ...
              >
                {' '}
                Expanding the offering is the choice between a leather strap or
                a metal bracelet, bringing the total new look. Black-tone
              ...
              <Link to="watches">
                <button className="btn btn-secondary slide-btn">
                  EXPLORE SERVICES
                </button>
              </Link>
            </div>
          ...
          <div className="slide-3  text-white  d-flex justify-content-center align-items-center">
            <div className="slide_content container text-center">
              ...
              <p
                ...
                style={{ color: '#aaaaaa' }}
              >
                One of the most advanced watch released during 2019. True style
                that always remains in fashion. Timepiece is the perfect
